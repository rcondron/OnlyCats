      ...
      <>
        ...
        <main className="min-h-screen px-4 py-8">
          <div className="max-w-6xl mx-auto text-center">
            <p className="text-xl text-white/70">Connect your wallet to view your cats</p>
          </div>
        </main>
      </>
    );
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {isLoading ? (
            <div className="text-center">
              <p className="text-xl text-white/70">Loading your warriors...</p>
            </div>
          ) : cats.length === 0 ? (
            <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {cats.map((cat, index) => (
                <div key={cat.id} className="card p-6 backdrop-blur-lg">
                  ...
                  <h2 className="text-2xl font-bold mb-2 neon-text">{cat.name}</h2>
